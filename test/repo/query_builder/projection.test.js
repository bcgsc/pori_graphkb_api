...
describe('nonSpecificProjection', () => {
    test('linkDepth 0', () => {
        const result = nonSpecificProjection('Statement', { depth: 0, edges: null });
    ...
    test('linkDepth 1', () => {
        const result = nonSpecificProjection('Statement', { depth: 1, edges: null });
        expect(result).toEqual([
            '@class',
            '@rid',
            '*',
    ...
    test('linkDepth 2', () => {
        const result = nonSpecificProjection('Statement', { depth: 2, edges: null });
        expect(result).toEqual([
            '@class',
            '@rid',
            '*',
    ...
    test('linkDepth 1 with edges', () => {
        const result = nonSpecificProjection('Statement', { depth: 1, edges: ['AliasOf'] });
...
describe('propsToProjection', () => {
    test('deeply nested projection', () => {
        const projection = propsToProjection('Statement', [
            'conditions.@rid',
            'conditions.@class',
...
describe('parsePropertyList', () => {
    test('deeply nested projection', () => {
        const obj = parsePropertyList('Statement', [
            'conditions.@rid',
            'conditions.@class',
            'conditions.reference1.@class',
            'conditions.reference1.@rid',
